...
class TestRegistration:
    ...
    def test_01_register_with_valid_details(self, driver, request):
        ...
        unique_email = f"john.doe.{uuid.uuid4()}@testmail.com"

        self._register(reg, "John", "Doe", unique_email, self.VALID_PASSWORD)

        WebDriverWait(driver, self.WAIT_MEDIUM).until(
            EC.url_contains("account/success")
        )
